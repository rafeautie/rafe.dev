...
interface TextRotateProps {
   ...
   */
  initial?: MotionProps['initial'] | Array<MotionProps['initial']>

  /**
   * Animation state to animate to or array of states.
   * @default { y: 0, opacity: 1 }
   */
  animate?: MotionProps['animate'] | Array<MotionProps['animate']>

  /**
   * Animation state when exiting or array of states.
   * @default { y: "-120%", opacity: 0 }
   */
  exit?: MotionProps['exit'] | Array<MotionProps['exit']>
    ...
    const getAnimationProps = useCallback(
      (index: number) => {
        const getProp = (
          prop:
            | MotionProps['initial']
            | Array<MotionProps['initial']>
            | MotionProps['animate']
            | Array<MotionProps['animate']>
            | MotionProps['exit']
            | Array<MotionProps['exit']>,
        ) => {
